...
export default function CTA() {
  ...
  return (
    <section className="bg-navy-gradient py-20 px-6 text-center">
      <div className="max-w-xl mx-auto">
        <img
          src={logoLight}
          alt="Kartarpur Journey"
          className="h-20 md:h-24 w-auto object-contain mx-auto mb-4 opacity-95 drop-shadow-[0_0_20px_rgba(255,215,0,0.25)]"
        />
